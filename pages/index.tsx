...
export default function Home() {
  return (
    <div className='home'>
      ...
      <div className="h-ad-content">
        <AdImage/>
        <div className="h-ad-text">
          <div className="h-ad-title">Foinbok</div>
          <div className="h-ad-body">
            Create content to articulate message about DAO operations, vision, mission and structure for social platforms.
          </div>
        </div>
      </div>
      <div className="h-down-cont">
        <div className='h-try-cont'>
          <div className="h-try-block">
            <div className="h-try-heading">There's a better way to engage to new members</div>
            <div className="h-try-content">You don’t want to let new members in your community turn inactive. Let the Foinbok bot take care of it.</div>
            <div className="h-try-button"><div>Try our Product</div></div>
          </div>

          <div className="h-down-svg">
